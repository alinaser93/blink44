...
/* بطاقة «عرض المنتجات» في نهاية الصف الأفقي (أسلوب بلينكيت) */
.bk-seeall-card{flex:0 0 auto;width:120px;align-self:stretch;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;cursor:pointer;background:#fff;border:1px solid #f0f0f0;border-radius:14px;padding:10px;}
.bk-seeall-card .thumbs{display:grid;grid-template-columns:1fr 1fr;gap:4px;}
.bk-seeall-card .thumbs .th{width:30px;height:30px;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:17px;overflow:hidden;}
.bk-seeall-card .thumbs .th img{width:100%;height:100%;object-fit:cover;}
.bk-seeall-card .arr{width:38px;height:38px;border-radius:50%;background:var(--bk-green,#0C831F);color:#fff;display:flex;align-items:center;justify-content:center;}
.bk-seeall-card .lbl{font-size:12.5px;font-weight:800;color:var(--bk-green,#0C831F);text-align:center;line-height:1.3;}
