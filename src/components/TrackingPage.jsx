...
const FLOW = ["جديد", "قيد التجهيز", "في الطريق", "تم التوصيل"];
const STEP_INFO = {
  "جديد": ["تم استلام طلبك", "وصل الطلب للمتجر"],
  "قيد التجهيز": ["قيد التجهيز", "المتجر يجهّز عناصر طلبك"],
  "في الطريق": ["في الطريق إليك", "المندوب استلم الطلب وانطلق"],
  "تم التوصيل": ["تم التوصيل 🎉", "بالعافية! نراك في الطلب القادم"],
};
